...
void World::SetInitialWorldSettings()
{
    ...
    if (ConfigMgr::GetBoolDefault("wardend.enable", true))
    {
        sLog->outString("Starting Warden system...");
        sWardenMgr->Initialize(ConfigMgr::GetStringDefault("wardend.address","127.0.0.1").c_str(),
        ConfigMgr::GetIntDefault("wardend.port", 4321),
        ConfigMgr::GetBoolDefault("wardend.ban", false));
